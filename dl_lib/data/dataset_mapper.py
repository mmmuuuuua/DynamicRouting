...
class DatasetMapper:
    ...
    def __init__(self, cfg, is_train=True):
        ...
        if hasattr(cfg.INPUT, 'CROP_PAD') and cfg.INPUT.CROP_PAD.ENABLED and is_train:
            ...
            logging.getLogger(__name__).info("CropPadGen used in training: "
                                             + str(self.crop_pad_gen))
        else:
